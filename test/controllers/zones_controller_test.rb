...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: {zone: {name: @zone.name, town_id: @zone.town_id, zone_id: @zone.zone_id}}
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: {zone: {name: @zone.name, town_id: @zone.town_id, zone_id: @zone.zone_id}}
