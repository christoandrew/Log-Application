...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { is_read: @notification.is_read, text: @notification.text, title: @notification.title } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { is_read: @notification.is_read, text: @notification.text, title: @notification.title } }
