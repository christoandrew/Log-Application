...
class MailingListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mailing_list" do
    assert_difference('MailingList.count') do
      post mailing_lists_url, params: { mailing_list: { customer_id: @mailing_list.customer_id } }
    end
  ...
  test "should update mailing_list" do
    patch mailing_list_url(@mailing_list), params: { mailing_list: { customer_id: @mailing_list.customer_id } }
